...
public class SMSTester {
	...
	public static void main(String[] args) {
		...
		/*
		 * Review this part (0), which should produce the expected output if you followed the tutorial videos properly. 
		 * NOTE: You may want to improve the getGPA() method in Student class, so that it returns 0.0 
		 * when the student has not registered any courses yet. 
		 */
		...
		System.out.println(sms.getMarks("Jim", "2030"));
		System.out.println(sms.getMarks("Jim", "1021"));
		System.out.println(sms.getMarks("Emily", "1021"));
		System.out.println(sms.getMarks("Emily", "3311"));
		...
		sms.setMarks("Jim", "2030", 67);
		sms.setMarks("Jim", "1021", 75);
		sms.setMarks("Emily", "1021", 88);
		sms.setMarks("Emily", "3311", 91);
		...
		System.out.println("Jim's GPA: " + sms.getGPA("Jim"));
		System.out.println("Emily's GPA: " + sms.getGPA("Emily"));
		...
		System.out.println(sms.getMarks("Jack", "2030"));
		System.out.println(sms.getMarks("Jack", "1021"));
		System.out.println(sms.getMarks("Jack", "3311"));
		...
		System.out.println(sms.getMarks("Jim", "3311"));
		System.out.println(sms.getMarks("Emily", "2030"));
		...
		sms.setMarks("Jim", "3311", 81);
		sms.setMarks("Emily", "2030", 71);
		System.out.println(sms.getMarks("Jim", "3311"));
		System.out.println(sms.getMarks("Emily", "2030"));
		System.out.println("Jim's GPA: " + sms.getGPA("Jim"));
		System.out.println("Emily's GPA: " + sms.getGPA("Emily"));
		...
		System.out.println("Size of SMS: " + sms.getStudents().length);
		System.out.print("Students successfully added: ");
		System.out.println(sms.getStudents()[2].name.equals("Jack"));
		...
		sms.addCourse("Jack", cr5);
		sms.addCourse("Jack", cr6);
		sms.addCourse("Jack", cr7);
		System.out.println(sms.getDescription());
		...
		sms.setMarks("Jack", "3311", 91);
		sms.setMarks("Jack", "4302", 84);
		sms.setMarks("Jack", "4080", 95);
		System.out.println(sms.getMarks("Jack", "3311"));
		System.out.println(sms.getMarks("Jack", "4302"));
		System.out.println(sms.getMarks("Jack", "4080"));
		System.out.println("Jack's GPA: " + sms.getGPA("Jack"));
	}
}